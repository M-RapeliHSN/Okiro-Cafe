...
<div align="center">
  <img src="Pastel Minimalist Cafe Logo.png" alt="ÖKIRO CAFÉ Logo" width="160" />
  <br />
...
![Menu Catalog Preview](preview-menu.png)
...
Website ini berarsitektur static murni (*no build step required*). Anda dapat menjalankannya dengan salah satu cara berikut:

### Opsi A: Menggunakan Browser Langsung
Cukup klik ganda file `index.html` di file explorer Anda.
...
Ikuti langkah-langkah berikut di terminal project:
...
git commit -m "feat: Initial commit website Okiro Cafe"

# 4. Ganti nama branch utama ke main
git branch -M main

# 5. Hubungkan ke repository remote GitHub Anda (ganti URL dengan repo Anda)
git remote add origin https://github.com/USERNAME/okiro-cafe.git
...
Karena project ini adalah static site dengan `index.html` di root, deploy ke Vercel sangat instan:

### Cara 1: Lewat Dashboard Vercel (Paling Mudah)
1. Buka [vercel.com](https://vercel.com) dan login.
2. Klik tombol **Add New...** → **Project**.
3. Pilih repository GitHub `okiro-cafe` yang baru saja Anda push.
4. Klik **Deploy** tanpa perlu mengubah pengaturan build.
5. Selesai! Website langsung aktif di alamat `https://okiro-cafe.vercel.app`.

### Cara 2: Lewat Terminal (Vercel CLI)
```bash
npx vercel
```
Tekan `Enter` untuk menyetujui opsi default, dan situs Anda akan langsung online dalam beberapa detik!
